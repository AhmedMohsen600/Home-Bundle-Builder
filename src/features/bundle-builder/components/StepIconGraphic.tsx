import { MemoryStick, Package, Truck } from 'lucide-react'
import type { StepIcon } from '../types/bundle.types'

interface StepIconGraphicProps {
  icon: StepIcon
  size?: number
}

export function StepIconGraphic({ icon, size = 22 }: StepIconGraphicProps) {
  const iconProps = {
    size,
    'aria-hidden': true,
  }
    ...
    case 'camera':
      return (
        <svg
          ...
          aria-hidden="true"
        >
          <g clipPath="url(#camera-icon-clip)">
            <path
